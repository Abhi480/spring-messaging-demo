...
/**
 * Exercise a simple_aq "point to point" queue.
 ...
 * SqsListener will process message by logging message content and some header values.
...
public class SimpleQueueDriver {
  ...
  private void execute(ApplicationContext context) throws Exception {
    ...
    jmsTemplate.convertAndSend("simple_aq text message");
  }
