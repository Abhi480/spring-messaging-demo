...
public class MessageListener {
   ...
   * @param arg
   */
  public void messageDisplay(MessagePayload arg) {
  ...
  e {commandId = 5, responseRequired = true, messageId = ID:duckman.local-55003-1387008116913-1:1:1:1:1, originalDestination = null,
      ...
      // nested exception is java.lang.NoSuchMethodException: com.digiburo.spring.demo.messaging.MessageListener.displayMessage(org.apache.activemq.command.ActiveMQMapMessage)
